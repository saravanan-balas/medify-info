      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold">Medify.info</span>
          </div>
          <p class="text-gray-300 mb-4">
            Medical awareness by students, for students and families. 
            Simple explanations for common health issues.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><NuxtLink to="/gallery" class="footer-link">Image Gallery</NuxtLink></li>
            <li><NuxtLink to="/videos" class="footer-link">Video Library</NuxtLink></li>
            <li><NuxtLink to="/join" class="footer-link">Join Us</NuxtLink></li>
            <li><a href="mailto:info@medify.info" class="footer-link">Contact</a></li>
          </ul>
        </div>
      </div>
      
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
        <p>&copy; 2025 Medify.info. All rights reserved. | Created by students for students</p>
      </div>
    </div>
  </footer>
</template>
